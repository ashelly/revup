...
class TestStackMainIntegration:
    """Integration tests for stack.main() with real git repos."""
    ...
    def test_no_topics_shows_message(self, git_repo, git_ctx):
        ...
        with patch("sys.stdout", output):
            result = run_async(stack.main(args, git_ctx))
    ...
    def test_independent_stacks_newest_first(self, git_repo, git_ctx):
        """Independent stacks should be ordered newest first (like git log).
